...
class payment_OgoneconnectorService extends payment_ConnectorService
{
	...
	{
		$html = '<ol><li>' . f_Locale::translate('&modules.order.frontoffice.Orderlist-status;') . ' : ' . f_Locale::translate(
	...
	private function filterSignParams($params, $filterIn = true)
	{
		...
		{
				$keyWords = array("AAVADDRESS", "AAVCHECK", "AAVZIP", "ACCEPTANCE", "ALIAS", "AMOUNT", "BRAND", 
...
/**
 * @param payment_persistentdocument_ogoneconnector $document
...
/**
 * @param payment_persistentdocument_ogoneconnector $fromDocument
 ...
 * @param payment_persistentdocument_ogoneconnector $toDocument
 * @param String $tag
 * @return void
 */
 ...
 *
 * @param payment_persistentdocument_ogoneconnector $newDocument
 * @param payment_persistentdocument_ogoneconnector $originalDocument
...
//	{
//		return array('module' => 'payment', 'template' => 'Payment-Inc-OgoneconnectorResultDetail');
//	}
}